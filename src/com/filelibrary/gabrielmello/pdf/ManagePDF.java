package com.filelibrary.gabrielmello.pdf;
 ...
 */
public class ManagePDF implements ManageFile {

    public <G> void generatePDFWithTable(List<G> list) {
    ...
    public File getFile(Option option) {
        return getChooseFile(TypeFile.PDF, option);
    }
